 ...
 * attachedFiles、recentAttachedFiles、activeFileFocus、projectFileFocus 和可选的 ToolCallLogRecorder；ToolCallingChatServiceImpl 在 AiTool.execute(arguments) 执行期间把本对象
