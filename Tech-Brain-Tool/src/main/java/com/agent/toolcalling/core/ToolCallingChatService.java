 ...
 * <p>调用链为：ChatMessageServiceImpl -> ToolCallingChatService.chatStream(currentMessage, historyMessages, callback) -> 公共编排器调用DeepSeekClient和ToolRegistry -> SSE逐token返回前端。</p>
