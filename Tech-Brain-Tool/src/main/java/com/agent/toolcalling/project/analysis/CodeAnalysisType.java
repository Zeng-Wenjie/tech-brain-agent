 ...
 * SseEventChainAnalyzer 执行真实静态分析 -> analyzeCode 返回统一 code_analysis 外层 JSON。</p>
 *
 * <p>边界说明：本枚举只描述 P5.1 到 P5.5 已完成的分析类型，不包含 P5.6 代码说明、P5.7 风险分析、
 * P5.8 测试步骤或 P5.9 开发日志保存。</p>
 */
